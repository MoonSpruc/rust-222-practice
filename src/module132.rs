...
// use std::num::ParseIntError;
//
// // Реалізація multiply з використанням ?
// fn multiply(n1_str: &str, n2_str: &str) -> Result<i32, ParseIntError> {
//     let n1 = n1_str.parse::<i32>()?;
//     let n2 = n2_str.parse::<i32>()?;
//     Ok(n1 * n2)
...
// }
//
// // Реалізація multiply1 з використанням and_then і map
...
// Створюємо аліас для Result
type Res<T> = Result<T, ParseIntError>;

// Використовуємо цей аліас для функції `multiply`
